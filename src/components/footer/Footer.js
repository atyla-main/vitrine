        ...
        <Grid className="footer-container">
          <Row className="show-grid">
            <Col sm={4} md={4}>
              ...
              <p>
                This is a bit of space where you expose
                your vision and the purpose of your
                enterprise. This is equivalent to the why
                part of a good comunication content set.
              </p>
            </Col>
            <Col sm={4} md={4}>
              ...
              <p>
                ...
                <a className="footer-link">- Explore ICO’s</a>
                <a className="footer-link">- How it works</a>
                <a className="footer-link">- About us</a>
                <a className="footer-link">- Sign-in / Sign-up</a>
                <a className="footer-link">- Add an ICO</a>
              </p>
            </Col>
            <Col sm={4} md={4}>
